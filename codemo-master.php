...
document.writeln('<script type="text/javascript" src="../content/plugins/codemo-master/ZeroClipboard.min.js"><\/script>');
$(function(){
...
var clip = new ZeroClipboard($("#xycopy"), {
  moviePath: "../content/plugins/codemo-master/ZeroClipboard.swf"
});
